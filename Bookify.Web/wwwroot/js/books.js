    ...
    "render": function (data, type, row) {
        ...
        "orderable": false,
        "render": function (data, type, row) {
                    return `<a href="#" style="display: flex; align-items: center;" class="btn  btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
            Actions
